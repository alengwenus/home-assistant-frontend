...
import { BinarySensorConfig } from "../../../../../../data/lcn";
...
export class LCNConfigBinarySensorElement extends LitElement {
  ...
  @property() private _sourceType: number = 0;
    ...
    return html`
      <form>
        ...
        >
          ...
          >
            ${this._sourceTypes.map((sourceType) => {
              return html`
        ...
        >
          ...
          >
            ${this._sourceTypes[this._sourceType].value.map((source) => {
              return html`
  ...
  private _sourceTypeChanged(ev: CustomEvent): void {
    ...
    const source = this._sourceTypes[this._sourceType].value[
